...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","92686988",(RemoteObject.concat(RemoteObject.createImmutable("Invalid link: "),httpjob.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_link))),RemoteObject.createImmutable(""))),0);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","92949128",RemoteObject.createImmutable("Cannot send files from the assets folder."),0);
