...
public static b4a.example.webservice _webservice = null;
  public Object[] GetGlobals() {
		return new Object[] {"hc",httputils2service._hc,"inputActivity",Debug.moduleToString(b4a.example.inputactivity.class),"loginActivity",Debug.moduleToString(b4a.example.loginactivity.class),"Main",Debug.moduleToString(b4a.example.main.class),"ouputActivity",Debug.moduleToString(b4a.example.ouputactivity.class),"Receiver",httputils2service.mostCurrent._receiver,"taskCounter",httputils2service._taskcounter,"TaskIdToJob",httputils2service._taskidtojob,"TempFolder",httputils2service._tempfolder,"WebService",Debug.moduleToString(b4a.example.webservice.class)};
}
}